...
from omniisaacgymenvs.robots.articulations.xarm import Xarm
from omniisaacgymenvs.robots.articulations.views.xarm_view import XarmView
from pxr import Usd, UsdGeom


class XarmBlock(RLTask):
    ...
    def get_xarm(self):
        ...
        xarm = Xarm(prim_path=self.default_zero_env_path + "/xarm6_with_gripper", name="xarm")
