...
class XarmView(ArticulationView):
    def __init__(
        ...
        self._hands = RigidPrimView(
            prim_paths_expr="/World/envs/.*/xarm6_with_gripper/xarm_gripper_base_link",
            name="hands_view",
            reset_xform_properties=False
        )
        # Add left finger as RigidPrimView
        self._lfingers = RigidPrimView(
            prim_paths_expr="/World/envs/.*/xarm6_with_gripper/left_finger",
            name="lfingers_view",
            reset_xform_properties=False
        )
        # Add right finger as RigidPrimView
        self._rfingers = RigidPrimView(
            prim_paths_expr="/World/envs/.*/xarm6_with_gripper/right_finger",
            name="rfingers_view",
            reset_xform_properties=False,
        )
